...
```
    ...
    ## 6 USW00013897 2016-12-15   0    -6    -1   Nashville, TN
...
```
    ...
    ## 3  1882    -1.51   -0.290    -0.09   -0.09    -0.07     0.02     0.04    0.6  
...
We can also do the inverse of `gather` and spread one column of data and
